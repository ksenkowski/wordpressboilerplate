...
define('SG_SITE_URL_REPLACEMENT', '%%sg_site_url%%');
...
// File name to be created if reloadings is possible
define('SG_CHECK_RELOAD_AVAILABILITY_FILE_NAME', 'reload.json');
...
define('SG_MIN_SUPPORTED_ARCHIVE_VERSION', 3);
define('SG_MAX_SUPPORTED_ARCHIVE_VERSION', 4);
